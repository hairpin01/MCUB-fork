...
class CommandModule(ModuleBase):
    ...
    strings = {
        "ru": {
            ...
            "load": "Загрузить:",
            "remove": "Удалить:",
            "list_modules": "Список репо:",
            "choose_language": '<tg-emoji emoji-id="6010399722471168034">❔</tg-emoji> Выберите язык',
            "setup_completed": '<tg-emoji emoji-id="6012423240478103267">🥰</tg-emoji> Настройка завершена!',
            "start_init_error": "Ошибка start_init:",
            "backup_setup": "Настройка авто-бэкапа",
            "backup_enable": '<tg-emoji emoji-id="6012610604131424315">🥺</tg-emoji> Включить авто-бэкап?',
            "backup_interval": "Выберите интервал:",
            "backup_created": "Группа MCUB-backup создана!",
            "backup_skip": "Пропустить",
            "backup_yes": "Да",
            "backup_no": "Нет",
            "backup_enabled": '<tg-emoji emoji-id="6012423240478103267">🥰</tg-emoji> Авто-бэкап включен',
            "backup_disabled": "Авто-бэкап выключен",
            "backup_not_found": "Модуль backup не найден",
        },
        "en": {
            ...
            "load": "Load:",
            "remove": "Remove:",
            "list_modules": "List repo:",
            "choose_language": '<tg-emoji emoji-id="6010399722471168034">❔</tg-emoji> Choose a language',
            "setup_completed": '<tg-emoji emoji-id="6012423240478103267">🥰</tg-emoji> Setup completed!',
            "start_init_error": "Error start_init:",
            "backup_setup": "Auto-backup setup",
            "backup_enable": '<tg-emoji emoji-id="6012610604131424315">🥺</tg-emoji> Enable auto-backup?',
            "backup_interval": "Select interval:",
            "backup_created": "MCUB-backup group created!",
            "backup_skip": "Skip",
            "backup_yes": "Yes",
            "backup_no": "No",
            "backup_enabled": '<tg-emoji emoji-id="6012423240478103267">🥰</tg-emoji> Auto-backup enabled',
